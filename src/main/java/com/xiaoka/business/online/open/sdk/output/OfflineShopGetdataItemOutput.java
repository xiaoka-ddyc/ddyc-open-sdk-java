 ...
 * @description:
 */
public class OfflineShopGetdataItemOutput {
	/**
	 * 城市
	 */
	private String city;
	...
	private List<OfflineShopGetdataItemServiceOutput> serviceList;
	...
	public List<OfflineShopGetdataItemServiceOutput> getServiceList() {
		return serviceList;
	}

	public void setServiceList(
			List<OfflineShopGetdataItemServiceOutput> serviceList) {
